...
class Control {
    ...
    showDebugInfo(component) {
        if (Control.isComponent(component)) {
            ...
            document.getElementById('c-type').innerText = '';
            document.getElementById('c-resistance').innerText = '';
            document.getElementById('c-voltage').innerText = '';
            document.getElementById('c-current').innerText = '';
            document.getElementById('c-maxCurrent').innerText = '';
