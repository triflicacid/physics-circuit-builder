Circuit.Buzzer = (function() {
    ...
    class Buzzer extends Circuit.Component {
         ...
         */
        get volume() { return clamp(Math.abs(this.current) / this.maxCurrent, 0, 1); }
            ...
            super.render((p, colour, running) => {
                ...
                if (running) {
                    ...
                    if (control._showInfo) {
                        ...
                        p.noStroke();
                        p.fill(0);
                        const vol = roundTo(volume * 100, 1);
                        p.text(vol + '%', 1, 15);
