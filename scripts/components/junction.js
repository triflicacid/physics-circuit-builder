Circuit.Junction = (function() {
     ...
     * @method render()
     * @method end()                    Make an end-junction
     */
    class Junction extends Circuit.Component {
        ...
        getResistance() {
            ...
            if (this.circuit1 === undefined || this.circuit1._isBroken) return this.circuit2.getResistance();
            if (this.circuit2 === undefined || this.circuit2._isBroken) return this.circuit1.getResistance();
        ...
        _setupConn(N, component, wirePath = []) {
            ...
            if (!Control.isComponent(component)) throw new TypeError(`Junction.setupConn${N}: cannot set-up connection with non-component`, component);
        ...
        /**
         * Make this junction into an end-junction
         */
        end() {
            this._isEnd = true;
            this._inputMax = 2;
