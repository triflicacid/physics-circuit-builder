        ...
        render() {
            ...
            Circuit.Component.prototype.render.call(this, (p, colour, running, circuitBroken) => {
                ...
                const rot_main = (this._dir === Diode.LEFT) ?
                    Circuit.DEG270 - Circuit.DEG45 :
                    -Circuit.DEG45;
                const rot_angle = (this._dir === Diode.LEFT) ?
                    this._angle + Circuit.DEG270 - Circuit.DEG45 :
                    this._angle - Circuit.DEG45;

                // Topmost
                p.push();
                let angle = this._angle + rot_main - Circuit.DEG10;
                ...
                // Bottommost
                p.push();
                angle = this._angle + rot_main + Circuit.DEG10 + Circuit.DEG5;
