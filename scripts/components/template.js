Circuit.Component = (function() {
    ...
    class Component {
         ...
         */
        eval(fn) {
            // console.log("EVAL ", this.constructor.name, this._circuit._depth);
            // Is this blown?
        ...
        connectTo(component, wirePath = []) {
            ...
            if (this._outputCount < this._outputMax && component._inputCount < component._inputMax) {
                ...
                if (this instanceof Circuit.Junction) {
                ...
                if (component instanceof Circuit.Junction && this._circuit._depth > 0) {
                    ...
                    if (originalCircuit !== null) {
                        ...
                        component.end(); // End of line for Junction
                    } else {
