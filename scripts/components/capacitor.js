Circuit.Capacitor = (function() {
    ...
    class Capacitor extends Circuit.Component {
        ...
        accessOneself() {
            ...
            return this.accessPath(this, false);
        }
            ...
            super.eval(() => {
                ...
                switch (state) {
                    ...
                    case Capacitor.CHARGING: {
                        this._chargeTime++;
                        const amount = this._asSeconds ? this.control.frames2secs(this._chargeTime) : this._chargeTime;
                    ...
                    case Capacitor.DISCHARGING: {
                        ...
                        const array = this.roundTrip(undefined, false);
                        for (let component of array) {
                            // I = V / R
                            component._current = this._voltage / component.resistance;
                        }
