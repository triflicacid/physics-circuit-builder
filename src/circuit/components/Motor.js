...
class Motor extends Component {
    constructor(parentCircuit) {
        super(parentCircuit);
        this._rotAngle = 0;
        this._K = utils.roundTo(utils.randomFloat(0.1, 2.5), 2);
    }
    ...
    get resistance() {
        return 4; //Component.LOW_RESISTANCE;
    }
     ...
     */
    angle() {
        let num = utils.roundTo(utils.rad2deg(this._rotAngle), 1);
    ...
    eval() {
        super.eval(() => {
            ...
            if (this._rotAngle > utils.Degrees._360) this._rotAngle = 0;
            else if (this._rotAngle < 0) this._rotAngle = utils.Degrees._360;
        });
    }
    ...
    onScroll(event) {
        ...
        const K = utils.clamp(this.K + delta, 1, 1e3);
        this._K = K;
    }
}
