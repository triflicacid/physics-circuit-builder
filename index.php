    ...
    <head>
        ...
        <?php
            foreach ($files as $file) {
                $file = "src/" . $file;
                if (is_dir($file)) {
                    $subfiles = glob($file . "*.js");
                    foreach ($subfiles as $subfile) {
                        echo scriptsrc($subfile) . "\n";
                    }
                } else {
                    echo scriptsrc($file . ".js") . "\n";
                }
            }
        ?>
                    ...
                    <div class="mainnav menu-tab" tab-target="components">
                        <table>
                            <tr>
                                ...
                                <td><a data-component="Cell" /></td>
                                <!-- <td><a data-component="Battery" /></td> -->
                                <td><a data-component="DC Power Supply" /></td>
                                <td><a data-component="AC Power Supply" /></td>
                                <!-- <td><a data-component="Capacitor" /></td> -->

                                <th><a target='_blank' href='components.php#analytical'>Measuring Components</a></th>
                                <td><a data-component="Ammeter" /></td>
                                <td><a data-component="Voltmeter" /></td>
                                <td><a data-component="Thermometer" /></td>
                                <td><a data-component="Lightmeter" /></td>
                                <!-- <td><a data-component="Wattmeter" /></td> -->

                                <th><a target='_blank' href='components.php#output'>Output Components</a></th>
                                <td><a data-component="Bulb" /></td>
                                <td><a data-component="LED" /></td>
                                <td><a data-component="Buzzer" /></td>
                                <td><a data-component="Heater" /></td>
                                <td><a data-component="Motor" /></td>

                                <th><a target='_blank' href='components.php#flow'>Flow Managing</a></th>
                                <td><a data-component="Switch" /></td>
                                <!-- <td><a data-component="Two-Way Switch" /></td> -->
                                <td><a data-component="Connector" /></td>
                                <td><a data-component="Diode" /></td>
                                <td><a data-component="Fuse" /></td>

                                <th><a target='_blank' href='components.php#resistors'>Resistors</a></th>
                                <td><a data-component="Resistor" /></td>
                                <td><a data-component="Variable Resistor" /></td>
                                <td><a data-component="Light-Dependant Resistor" /></td>
                                <td><a data-component="Thermistor" /></td>
                                <td><a data-component="Wire Container" /></td>
                                <td><a data-component="Material Container" /></td>
                            </tr>
                        </table>
                    </div>
